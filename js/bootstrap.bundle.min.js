...
(this, function(t, e) {
    ...
    , p), _t=(m="button", v="."+(_="bs.button"), E=".data-api", y=(g=e).fn[m], b="active", T="btn", w='[data-toggle^="button"]', I='[data-toggle="buttons"]', D="input", A=".active", S=".btn", O= {
        CLICK_DATA_API: "click"+v+E, FOCUS_BLUR_DATA_API:(C="focus")+v+E+" blur"+v+E
    }
    ...
    , Z=function() {
        ...
        , t._getConfig=function(t) {
            ...
            , R, t), gt.typeCheckConfig(L, t, H), t
        }
        ...
        , o._dataApiClickHandler=function(t) {
            ...
            if(e) {
                ...
                if(n&&k(n).hasClass(V)) {
                    ...
                    , k(n).data(), k(this).data()), r=this.getAttribute("data-slide-to");
    ...
    , pt=function() {
        ...
        , t.hide=function() {
            ...
            if( !this._isTransitioning&&$(this._element).hasClass(at)) {
                ...
                if($(this._element).trigger(e),  !e.isDefaultPrevented()) {
                    ...
                    if(this._element.style[n]=this._element.getBoundingClientRect()[n]+"px", gt.reflow(this._element), $(this._element).addClass(ct).removeClass(lt).removeClass(at), 0<this._triggerArray.length)for(var i=0;
        ...
        , t._getConfig=function(t) {
            ...
            , rt, t)).toggle=Boolean(t.toggle), gt.typeCheckConfig(tt, t, ot), t
        }
    ...
    , pt), yt="undefined" !=typeof window&&"undefined" !=typeof document, bt=["Edge", "Trident", "Firefox"], Tt=0, Ct=0;
    Ct<bt.length;

    Ct+=1)if(yt&&0<=navigator.userAgent.indexOf(bt[Ct])) {
        Tt=1;
        break
    }
    ...
    function Lt(t) {
        ...
        for(var e=kt(10)?document.body: null, n=t.offsetParent;
    ...
    function Ht() {
        ...
        return {
            height: Rt("Height", t, e, n), width:Rt("Width", t, e, n)
        }
    }
    ...
    function Vt(t) {
        ...
        , s=o.width||t.clientWidth||r.right-r.left, a=o.height||t.clientHeight||r.bottom-r.top, l=t.offsetWidth-s, c=t.offsetHeight-a;
        ...
        , modifiers: {
                ...
                order:300, enabled: !0, fn:function(t, i) {
                    ...
                    var c=i.priority, f=t.offsets.popper, h= {
                        primary:function(t) {
                            ...
                            return f[t]<l[t]&& !i.escapeWithReference&&(e=Math.max(f[t], l[t])), Ut( {}
                        ...
                        , secondary:function(t) {
                            ...
                            return f[t]>l[t]&& !i.escapeWithReference&&(n=Math.min(f[e], l[t]-("right"===t?f.width: f.height))), Ut( {}
            ...
            , arrow: {
                order:500, enabled: !0, fn:function(t, e) {
                    ...
                    return E=Math.max(Math.min(s[c]-p, E), 0), t.arrowElement=i, t.offsets.arrow=(Ut(n= {}

                    , h, Math.round(E)), Ut(n, u, ""), n), t
                }
            ...
            , flip: {
                order:600, enabled: !0, fn:function(p, g) {
                    ...
                    switch(g.behavior) {
                        case ue.FLIP: y=[_, v];
                        break;
                        case ue.CLOCKWISE: y=he(_);
                        break;
                        case ue.COUNTERCLOCKWISE: y=he(_,  !0);
                        break;
                        default: y=g.behavior
                    }
                    ...
                    return y.forEach(function(t, e) {
                        ...
                        (s||h||d)&&(p.flipped= !0, (s||h)&&(_=y[e+1]), d&&(E="end"===(n=E)?"start": "start"===n?"end":n), p.placement=_+(E?"-"+E:""), p.offsets.popper=Bt( {}
            ...
            , computeStyle: {
                order:850, enabled: !0, fn:function(t, e) {
                    ...
                    , _, t.attributes), t.styles=Bt( {}

                    , l, t.styles), t.arrowStyles=Bt( {}
    ...
    , ge=function() {
        function o(t, e) {
            ...
            , this.update=wt(this.update.bind(this)), this.options=Bt( {}

            , o.Defaults, i), this.state= {
    ...
    , Ve=function() {
        ...
        , t._getConfig=function(t) {
            ...
            , this.constructor.Default, me(this._element).data(), t), gt.typeCheckConfig(_e, t, this.constructor.DefaultType), t
        }
        ...
        , l._clearMenus=function(t) {
            if( !t||3 !==t.which&&("keyup" !==t.type||9===t.which))for(var e=me.makeArray(me(ke)), n=0;
            n<e.length;
    ...
    , sn=function() {
        ...
        , t._getConfig=function(t) {
            ...
            , Xe, t), gt.typeCheckConfig(Ye, t, Je), t
        }
    ...
    , sn), wi=(ln="tooltip", fn="."+(cn="bs.tooltip"), hn=(an=e).fn[ln], un="bs-tooltip", dn=new RegExp("(^|\\s)"+un+"\\S+", "g"), mn= {
        animation: !0, template:'<div class="tooltip" role="tooltip"><div class="arrow"></div><div class="tooltip-inner"></div></div>', trigger:"hover focus", title:"", delay:0, html: !(gn= {
    ...
    , yn="fade", bn="show", Tn=".tooltip-inner", Cn=".arrow", wn="hover", In="focus", Dn="click", An="manual", Sn=function() {
        ...
        , t._getConfig=function(t) {
            ...
            , this.constructor.Default, an(this.element).data(), "object"==typeof t&&t?t: {}
    ...
    , Sn), Ii=(Nn="popover", Ln="."+(kn="bs.popover"), Pn=(On=e).fn[Nn], xn="bs-popover", jn=new RegExp("(^|\\s)"+xn+"\\S+", "g"), Mn=c( {}
    ...
    , Jn= {
        ACTIVATE: "activate"+Gn, SCROLL:"scroll"+Gn, LOAD_DATA_API:"load"+Gn+".data-api"
    }
    ...
    (), Vn(window).on(Jn.LOAD_DATA_API, function() {
        for(var t=Vn.makeArray(Vn(ti.DATA_SPY)), e=t.length;
        e--;
